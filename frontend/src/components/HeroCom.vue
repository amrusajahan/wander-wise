        ...
        <div
            ...
            <div class="relative w-full pr-10 rounded-lg cursor-pointer md:w-2/3 lg:w-1/2 group">
                <div class="relative rounded-md">
                    ...
                    <img src="@\assets\img\Directions-amico.png" class="z-10 object-cover w-full h-full">
                </div>
            </div>
            <div
                ...
                <h1
                    class="relative z-20 text-4xl font-extrabold leading-none text-black sm:text-5xl xl:text-6xl sm:text-center lg:text-left">
                    <span class="relative">
                        <span
                            class="absolute bottom-0 left-0 inline-block w-full h-4 mb-1 -ml-1 transform -skew-x-3 bg-yellow-200"></span>
                        <span class="relative">Explore Galle,</span>
                    </span>
                    <span class="relative block text-yellow-400">Navigate Routes.</span>
                    <span class="relative block text-yellow-400">Discover Landmarks!</span>
                </h1>
                <p class="relative z-20 block mt-6 text-base text-gray-500 xl:text-lg sm:text-center lg:text-left">
                    Join our community at WanderWise! Together, we explore routes, discover landmarks, and find peace in traveling.</p>
                <div class="relative mt-10">
                    <a href="#_"
                        class="flex items-center self-center justify-center px-5 py-3 text-base font-medium leading-tight text-white transition duration-150 ease-in-out bg-yellow-500 border border-transparent rounded-lg shadow hover:bg-yellow-600 focus:outline-none focus:border-yellow-600 focus:shadow-outline-yellow md:py-4 md:text-lg xl:text-xl md:px-10">Get
                        Started</a>
                    <!-- <a href="#_"
